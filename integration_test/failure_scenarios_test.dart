...
void main() {
  ...
  group('Failure Scenarios - E2E Tests', () {
    ...
    testWidgets('TC-FAIL-001: Login with Empty Fields', (WidgetTester tester) async {
      await app.main();
    ...
    testWidgets('TC-FAIL-002: Invalid Email Format', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-FAIL-004: Negative Price Input', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
      ...
      if (tester.any(treatmentButton)) {
        ...
        if (tester.widgetCount(priceField) > 0) {
    ...
    testWidgets('TC-FAIL-006: Duplicate Invitation Email', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-FAIL-007: Network Error Recovery', (WidgetTester tester) async {
    ...
    testWidgets('TC-FAIL-008: Invalid Token in Registration Link', (WidgetTester tester) async {
    ...
    testWidgets('TC-FAIL-009: Expired Invitation Token', (WidgetTester tester) async {
    ...
    testWidgets('TC-FAIL-010: Maximum Character Limits', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
