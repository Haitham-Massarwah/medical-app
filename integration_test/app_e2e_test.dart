...
void main() {
  ...
  group('Medical Appointment System - E2E Tests', () {
    ...
    testWidgets('TC-AUTH-001: Successful Login as Doctor', (WidgetTester tester) async {
      await app.main();
    ...
    testWidgets('TC-AUTH-002: Failed Login - Invalid Credentials', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-AUTH-003: Successful Login as Customer', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-AUTH-004: Successful Login as Developer', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-AUTH-005: Logout Functionality', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DOC-001: Doctor Enables Online Payments', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DOC-002: Doctor Sets Treatment Price', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DOC-003: Doctor Disables Payments - Price Fields Hidden', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-INV-001: Doctor Sends Customer Invitation', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-INV-002: Doctor Invites with Invalid Email - Error', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-BOOK-001: Customer Views Doctor with Prices', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-BOOK-002: Customer Books Appointment', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-BOOK-003: Customer Views Appointment Without Prices When Payments Disabled', 
    ...
    testWidgets('TC-REG-001: Registration Link Validation - Valid Token', (WidgetTester tester) async {
    ...
    testWidgets('TC-REG-002: Registration Link Validation - Expired Token', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-REG-003: Registration Link Validation - Invalid Token', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DEV-001: Developer Views All Doctors', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DEV-002: Developer Views System Logs', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-DEV-003: Developer Overrides Payment Settings', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-FAIL-001: Network Error Handling', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-FAIL-002: Invalid Date Selection', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-FAIL-003: Duplicate Booking Prevention', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-APT-001: Doctor Views Appointments', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-APT-002: Doctor Updates Appointment Status', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-APT-003: Customer Cancels Appointment', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('TC-PAY-001: Customer Sees Price Before Booking', (WidgetTester tester) async {
      await app.main();
      await tester.pumpAndSettle();
