...
const knex = require('knex')({
  ...
  connection: {
    ...
    password: process.env.DB_PASSWORD || 'Haitham@0412',
...
async function createAccounts() {
  try {
    console.log('🔧 Creating developer and example accounts...\n');
    ...
    const developerPassword = 'Developer@2024';
    ...
    if (!doctorUser) {
      ...
      // Create doctor profile (matching actual schema)
      await knex('doctors')
        .insert({
          user_id: docUser.id,
          tenant_id: tenantId,
